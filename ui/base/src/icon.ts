...
import { createElement, Menu, Home, Search, Bell, User, Download, Upload, MessageCircleMore, CircleX } from "lucide";

type Icons = "menu" | "home" | "search" | "bell" | "user" | "download" | "upload" | "chat" | "close";
