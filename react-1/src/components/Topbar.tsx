    ...
    <nav className="r1-bg-gradient-to-r r1-from-yellow-400 r1-to-yellow-600 r1-p-4 r1-shadow-lg">
      <div className="r1-container r1-mx-auto r1-flex r1-items-center r1-justify-between">
        <div className="r1-flex r1-items-center r1-space-x-2">
          <svg
            className="r1-h-8 r1-w-8 r1-text-white"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <div className="r1-flex r1-items-center r1-space-x-4">
          ...
          <div className="r1-h-8 r1-w-8 r1-rounded-full r1-ring-2 r1-ring-white r1-text-white r1-flex r1-justify-center r1-items-center">
            <my-icon icon="user" />
          </div>
...
const NavButton = ({
  icon,
  text,
}: PropsWithChildren<{ icon: JSX.Element; text: string }>) => (
  <button className="r1-flex r1-items-center r1-space-x-1 r1-text-white r1-hover:bg-white r1-hover:bg-opacity-20 r1-px-3 r1-py-2 r1-rounded-md r1-transition r1-duration-300">
    {icon}
    <span>{text}</span>
  </button>
);
